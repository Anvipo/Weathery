...
private fun Context.parse1xxHttpCode(code: Int): String =
    when (code) {
...
private fun Context.parse2xxHttpCode(code: Int): String =
    when (code) {
...
private fun Context.parse3xxHttpCode(code: Int): String =
    when (code) {
...
private fun Context.parse4xxHttpCode(code: Int): String =
    when (code) {
...
private fun Context.parse5xxHttpCode(code: Int): String =
    when (code) {
